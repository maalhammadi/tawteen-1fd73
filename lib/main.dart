...
import 'package:tawteen/login/login_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<TawteenFirebaseUser> userStream;
  TawteenFirebaseUser initialUser;
  final authUserSub = authenticatedUserStream.listen((_) {});

  @override
  void initState() {
    super.initState();
    userStream = tawteenFirebaseUserStream()
